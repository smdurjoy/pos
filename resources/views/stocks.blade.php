                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active"><a href=" {{url('/stock-report')}} ">Stock Report</a></li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="{{ url('/print/stock') }}" class="btn btn-dark btn-sm" style="float: right" target="_blank"><i class="fa fa-print"></i> Generate pdf</a>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
